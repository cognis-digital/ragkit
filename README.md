...
[![PyPI](https://img.shields.io/pypi/v/cognis-ragkit.svg)](https://pypi.org/project/cognis-ragkit/)
[![CI](https://github.com/cognis-digital/ragkit/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/ragkit/actions)
...
RAGKIT exists for one job — batteries-included local rag pipeline — ingest, index, serve — and does it without a SaaS bill or heavyweight setup.
...
```bash
ragkit --version
ragkit scan .                      # scan the current project
ragkit scan . --format json
ragkit scan . --fail-on high       # non-zero exit for CI gates
ragkit mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **RAGFlow**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`ragkit` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
