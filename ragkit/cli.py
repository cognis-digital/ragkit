...
import argparse, sys
from ragkit.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="ragkit", description="RAGKIT — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from ragkit.mcp_server import serve
        return serve()
    if args.cmd == "scan":
