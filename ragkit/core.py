"""RAGKIT core — Batteries-included local RAG pipeline — ingest, index, serve."""
...
RULES = [
    ("RAG-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("RAG-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("RAG-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
