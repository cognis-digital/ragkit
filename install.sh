#!/usr/bin/env sh
# Universal installer for ragkit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ragkit.git"
echo "Installing ragkit ..."
